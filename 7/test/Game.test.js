...
// Mock the UI class to avoid console output during tests
jest.mock('../src/UI', () => {
  return jest.fn().mockImplementation(() => {
    return {
      ...
      displayShipsPlaced: jest.fn(),
      displayIntro: jest.fn(),
      displayBoards: jest.fn(),
      displayStatus: jest.fn(),
      displayError: jest.fn(),
      displayAttackResult: jest.fn(),
      displayCPUTurn: jest.fn(),
      displayCPUTarget: jest.fn(),
      displayGameOver: jest.fn(),
      getInput: jest.fn().mockResolvedValue('00')
    };
  });
});
...
describe('Game', () => {
  ...
  describe('gameLoop', () => {
    test('should handle complete game flow until victory', async () => {
      ...
      game.humanPlayer.setupBoard(1, 3);
      game.cpuPlayer.setupBoard(1, 3);
  ...
  describe('getGameStats', () => {
    test('should return correct game statistics', () => {
      game.humanPlayer.setupBoard(2, 3);
      game.cpuPlayer.setupBoard(2, 3);
  ...
  describe('processHumanTurn', () => {
    beforeEach(() => {
      ...
      // Mock UI getInput to return valid input
      game.ui.getInput.mockResolvedValue('00');
