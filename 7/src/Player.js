...
class Player {
   ...
   * @param {boolean} markOnGrid - Whether to mark ships on grid (true for human, false for CPU)
   */
  setupBoard(numShips, shipLength, markOnGrid = true) {
    this.board.placeShipsRandomly(numShips, shipLength, markOnGrid);
  }
